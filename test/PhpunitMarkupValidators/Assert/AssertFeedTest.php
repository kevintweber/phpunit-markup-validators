...
class AssertFeedTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIsValidMarkup()
    {
        ...
        AssertFeed::IsValidMarkup(
            '<?xml version="1.0" encoding="UTF-8" ?><rss version="2.0"><channel><title>RSS Title</title><description>RSS feed</description><link>http://www.someexamplerssdomain.com/main.html</link><lastBuildDate>Mon, 06 Sep 2010 00:01:00 +0000 </lastBuildDate><pubDate>Mon, 06 Sep 2010 16:45:00 +0000 </pubDate><ttl>1800</ttl>
...
<item><title>Example</title><description>text description</description><link>http://www.example.com/</link><guid>http://www.example.com/123</guid><pubDate>Mon, 06 Sep 2010 16:45:00 +0000</pubDate>',
    ...
    public function testIsValidFile()
    {
        ...
        AssertFeed::IsValidFile(
            realpath(__DIR__."/../../files/RSS20_Valid.rss"),
            "Valid RSS 2.0 file."
        );
        ...
        try {
            AssertFeed::IsValidFile(
                realpath(__DIR__."/../../files/RSS20_Invalid.rss"),
